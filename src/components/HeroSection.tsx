  ...
  return (
    <section id="top" style={{ position: 'relative', padding: '80px 26px 80px', background: 'linear-gradient(180deg,#FBFAFE 0%,#fff 62%)', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', maxWidth: 1440, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(400px,1fr))', gap: 56, alignItems: 'center' }}>
        <div>
          <span data-reveal="" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '7px 15px 7px 11px', borderRadius: 999, background: '#fff', border: '1px solid #E7DFFA', fontSize: 14, color: '#6D28D9', boxShadow: '0 4px 14px -8px rgba(109,40,217,.5)' }}>
          ...
          <h1 data-reveal="" data-reveal-delay="70" style={{ fontFamily: "'Poppins',system-ui,sans-serif", fontSize: 'clamp(40px,4.6vw,60px)', lineHeight: 1.1, letterSpacing: '-.028em', fontWeight: 700, margin: '24px 0 0', color: '#17131F' }}>
            Scheduling made <span style={{ color: '#7C3AED' }}>simple.</span> Meetings made <span style={{ color: '#7C3AED' }}>productive.</span>
          </h1>

          <p data-reveal="" data-reveal-delay="140" style={{ fontSize: 19, lineHeight: 1.62, color: '#5A5468', margin: '22px 0 0', maxWidth: 520 }}>SnaarpMe helps you book, manage, and automate meetings so you can focus on growing your business.</p>

          <div data-reveal="" data-reveal-delay="210" style={{ display: 'flex', flexWrap: 'wrap', gap: 12, marginTop: 32 }}>
            <a href="#signup" style={{ display: 'inline-flex', alignItems: 'center', gap: 9, padding: '15px 26px', borderRadius: 12, background: '#7C3AED', color: '#fff', fontSize: 16, fontWeight: 700, boxShadow: '0 14px 28px -14px rgba(109,40,217,.95)', transition: 'background 180ms ease,box-shadow 180ms ease' }}>
              Get started free
            ...
            <a href="#how" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '15px 24px', borderRadius: 12, background: '#fff', border: '1px solid #E4DDF3', color: '#17131F', fontSize: 16, fontWeight: 700, transition: 'border-color 180ms ease,background 180ms ease' }}>
          ...
          <div data-reveal="" data-reveal-delay="280" style={{ display: 'flex', flexWrap: 'wrap', gap: '8px 20px', marginTop: 30 }}>
